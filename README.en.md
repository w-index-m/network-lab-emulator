...
![Tests](https://img.shields.io/badge/tests-1234%20passed-brightgreen)
...
```bash
pytest tests/                           # full suite (1234 tests, ~15 min)
...
**Current status: 1234 passed / 5 skipped / 0 failed** across 86 test files.
